...
# Adapted from scikit-learn/sklearn/calibration.py
# Only change  _get_prediction_method function
#  Original Author: Alexandre Gramfort <alexandre.gramfort@telecom-paristech.fr>
...
def _get_prediction_method(clf):
    ...
    if hasattr(clf, "predict_proba"):
        ...
        raise RuntimeError(
            "'base_estimator' has no 'predict_proba' method."
        )
