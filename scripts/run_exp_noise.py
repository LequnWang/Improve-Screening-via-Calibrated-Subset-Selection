"""
Run the experiments where we vary the quality of the predictor by adding noise to the predictor.
"""
import os
...
if __name__ == "__main__":
    ...
    commands = generate_commands(exp_dir, n_trains, n_cals, n_test, lbds, runs, n_runs_test, k, alpha, classifier_type,
