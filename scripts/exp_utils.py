...
def generate_commands(exp_dir, n_trains, n_cals, n_test, lbds, runs, n_runs_test, k, alpha, classifier_type,
                    ...
                    for run in runs:
                        ...
                        if classifier_type == "LR":
                            train_classifier_command = "python ./src/train_LR.py --train_data_path {} --lbd {} " \
                                                       ...
                                                       "--classifier_path {}".format(train_data_path, lbd, noise_ratio,
                        ...
                        for umb_num_bin in umb_num_bins:
                            ...
                            umb_prediction_command = "python ./src/umb_ss.py --cal_data_path {} " \
                                                     "--test_raw_path {} --classifier_path {} --result_path {} --k {}" \
                                                     " --m {} --alpha {} --B {} " \
                                                     "--scaler_path {}".format(cal_data_path, test_raw_path,
                                                                               classifier_path, umb_result_path, k, n_test,
